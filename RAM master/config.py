...
glimpse_arg.add_argument(
    "--glimpse_scale", type=int, default=3, help="scale of successive patches"
)
glimpse_arg.add_argument(
...
misc_arg.add_argument(
    "--data_dir", type=str, default=F"/content/gdrive/MyDrive/Colab Notebooks/ESE 546", help="Directory in which data is stored"
)
misc_arg.add_argument(
    "--ckpt_dir",
    type=str,
    #default = "./ckpt",
    default = "/content/drive/My Drive/ESE 546 Project Fall 2021/RAM master",
