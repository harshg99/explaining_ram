...
def add_clutter_and_translate_img(x, N_clutter, clutter_sz, to_sz):
    ...
    x_t = -torch.ones(B,C,to_sz,to_sz) # background of MNIST is mapped to -1
...
class Trainer:
    ...
    def train_one_epoch(self, epoch):
        ...
        with tqdm(total=self.num_train) as pbar:
            for i, (x1, y) in enumerate(self.train_loader):
                ...
                x = add_clutter_and_translate_img(x1, N_clutter=4, clutter_sz=8, to_sz=60)
    ...
    def validate(self, epoch):
        ...
        for i, (x1, y) in enumerate(self.valid_loader):
            y = y.to(self.device)
    ...
    def test(self):
        ...
        for i, (x1, y) in enumerate(self.test_loader):
            y = y.to(self.device)
